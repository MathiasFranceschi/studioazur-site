...
async function onRequestPost(context) {
  ...
  try {
        ...
        content: [
          {
            ...
            value: [
              `Nom : ${name}`,
              `Email : ${email}`,
              `Service : ${service || "Non sp\xE9cifi\xE9"}`,
              ``,
              `Message :`,
              message,
              ``,
              `---`,
              `Envoy\xE9 depuis le formulaire studioazur.dev`
            ].join("\n")
          },
          {
            type: "text/html",
            value: `
              <div style="font-family:sans-serif;max-width:600px;">
                ...
                <table style="width:100%;border-collapse:collapse;">
                  ...
                  <tr><td style="padding:8px 0;color:#5a5a55;"><strong>Service</strong></td><td style="padding:8px 0;">${escapeHtml(service || "Non sp\xE9cifi\xE9")}</td></tr>
                </table>
                ...
                <p style="margin-top:24px;font-size:12px;color:#8a8a82;">Envoy\xE9 depuis le formulaire studioazur.dev</p>
              </div>`
          }
        ]
      })
    ...
    return new Response(
      JSON.stringify({ error: "Erreur lors de l'envoi. Veuillez r\xE9essayer." }),
      { status: 500, headers }
    );
  } catch (err) {
    console.error("Contact function error:", err);
    return new Response(
      JSON.stringify({ error: "Erreur serveur. Veuillez r\xE9essayer." }),
      { status: 500, headers }
    );
  }
}
...
// ../.wrangler/tmp/pages-X4s0Pd/functionsRoutes-0.3192786006439384.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-f4H2gn/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-f4H2gn/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7151184810660988.mjs.map
